            ...
            <div className="bg-[#0A0A0A] border border-white/10 p-8 rounded-2xl shadow-xl flex flex-col justify-center h-full relative overflow-hidden">
              ...
              <AnimatePresence mode="wait">
                {status === 'idle' && (
                  ...
                  >
                    <div className="mb-6">
                      <label className="flex items-center gap-2 text-sm font-bold text-gray-400 uppercase tracking-wider mb-3"><Target size={16} className="text-red-500"/> Kogo chcesz prze艣wietli膰?</label>
                      <input 
                        type="text" 
                    ...
                    <div className="mb-8">
                      <label className="flex items-center gap-2 text-sm font-bold text-gray-400 uppercase tracking-wider mb-3"><Mail size={16} className="text-red-500"/> Podaj e-mail, aby odblokowa膰 raport</label>
                      <input 
                        type="email" 
                    ...
                    >
                      <Lock size={20} /> Odblokuj Bibliotek臋 Reklam
                    </button>
                ...
                {status === 'complete' && (
                  ...
                  >
                    ...
                    <p className="text-gray-400 text-sm mb-6">Raport zosta艂 odblokowany pomy艣lnie. Mo偶esz teraz bezpiecznie przejrze膰 aktywne reklamy konkurencji.</p>
                    <button 
            ...
            <AnimatePresence mode="wait">
              {status !== 'complete' ? (
                ...
                >
                  ...
                  <p className="max-w-xs">Panel dost臋pu jest zablokowany. Wype艂nij formularz po lewej stronie, aby wygenerowa膰 bezpieczny link.</p>
                </motion.div>
              ) : (
                <motion.div 
                  key="unlocked"
                ...
                >
                  ...
                  <div className="bg-red-500/5 border border-red-500/20 p-8 rounded-xl relative group">
                    ...
                    >
                      Otw贸rz Bibliotek臋 Meta <ExternalLink size={18} />
                    </a>
                  </div>
                  ...
                  <div className="bg-[#0A0A0A] border border-white/10 p-8 rounded-2xl flex flex-col justify-center shadow-xl flex-grow relative overflow-hidden">
                    ...
                    <div className="space-y-4 relative z-10">
                      <a href="/#contact" className="inline-flex items-center gap-2 text-white font-bold hover:text-red-500 transition-colors group text-sm border-b border-white hover:border-red-500 pb-1">
                        Zle膰 nam zbadanie Twojego rynku <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
                      </a>
                    </div>
                  </div>
                </motion.div>
