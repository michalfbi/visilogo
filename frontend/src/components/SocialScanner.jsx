    ...
    <div className="min-h-screen bg-black pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-4xl">
        <div className="text-center mb-16">
          ...
          >
            Sprawdź, czy Twój link <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">odstrasza inwestorów</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Wysyłasz ofertę na LinkedIn lub mailu? Zobacz dokładnie, co widzi prezes po drugiej stronie ekranu, zanim w ogóle kliknie w link.
          </motion.p>
        </div>
